...
use crate::parser::resources::{
    AUTHHANDLER_PARSER, BUCKET_PARSER, CRON_PARSER, ENDPOINT_PARSER, GATEWAY_PARSER,
    METRIC_PARSER, SECRET_PARSER, SERVICE_PARSER, SQLDB_PARSER, SUBSCRIPTION_PARSER, TOPIC_PARSER,
};
